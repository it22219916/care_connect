        ...
        <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
            <div className="page-wrapper">
                <div className="content">
                                ...
                                <select name="patientId" id="patientId" className="form-select">
                                    <option value=''>Choose Patient</option>
                                    {
                                        patientList.map(patient => (
                                            <option value={patient._id} selected={patientSelected === patient._id}>
                                    ...
                                    <select name="doctorId" id="doctorId" className="form-select">
                                        <option value=''>Choose Doctor</option>
                                        {
                                            doctorList.map(doctor => (
                                                <option value={doctor._id} selected={doctorSelected === doctor._id}>
                    ...
                    {/* QR Code Scanner */}
                    {scannerOpen && (
                        <div className="qr-scanner mt-3" style={{ maxWidth: '300px', margin: '0 auto', border: '1px solid #ccc', borderRadius: '8px', overflow: 'hidden' }}>
                            <QrReader
                                onScan={handleScan}
                                onError={handleError}
